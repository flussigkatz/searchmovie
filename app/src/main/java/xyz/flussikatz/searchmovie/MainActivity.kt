...
//        filmRecycler.favorite.setOnCheckedChangeListener { _, isChecked ->
//            val newList = filmsAdapter.items
//            newList[FilmListRecyclerAdapter(object : FilmListRecyclerAdapter.OnItemClickListener {override fun click(film: Film) {}}).FilmViewHolder(filmRecycler).adapterPosition].fav_state = isChecked
//            filmsAdapter.items[FilmListRecyclerAdapter(object : FilmListRecyclerAdapter.OnItemClickListener {override fun click(film: Film) {}}).FilmViewHolder(filmRecycler).adapterPosition].fav_state = isChecked
//            updateData(filmsAdapter, newList)
//
//        }
