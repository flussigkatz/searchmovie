...
object NotificationHelper {
    ...
    fun initNotification(context: Context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val nChannel = NotificationChannel(
                NotificationConstants.NOTIFICATON_CHANNEL_ID,
                channelName,
                importance
            )
    ...
    fun createBoringKillerNotification(context: Context, film: Film) {
        val bundle = Bundle()
        val intentBoringKillerInit = Intent()
        intentBoringKillerInit.action = NotificationConstants.BORING_KILLER_NOTIFICATION_FILM_KEY
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            intentBoringKillerOff.action = NotificationConstants.BORING_KILLER_NOTIFICATION_KEY_OFF
