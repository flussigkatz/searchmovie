...
@AppScope
class UpcomingFilmsFragmentViewModel @Inject constructor(private val interactor: Interactor) : ViewModel() {
    val filmFlow = interactor.getFilms(UPCOMING_CATEGORY).catch { Timber.d(it) }
